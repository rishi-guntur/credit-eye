...
try:
    ...
    fig2 = go.Figure()
    fig2.add_trace(go.Scatter(x=d['HY_Spread'].index, y=d['HY_Spread'], name="High Yield Spread"))
    ...
    fig4 = go.Figure()
    fig4.add_trace(go.Bar(x=d['Revolving'].index[-60:], y=d['Revolving'][-60:], name="Credit Card Debt ($B)"))
